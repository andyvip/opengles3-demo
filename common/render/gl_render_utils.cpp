...
namespace glrender
{
    ...
    extern GLRender *CreateTriangleRenderMapBuffer();
    extern GLRender *CreateCubeRender();
    ...
    GLRender *CreateRender(GLRenderType type) {
        ...
        switch (type) {
            ...
            case kTriangleRenderVAO:
                ...
                break;
            case kTriangleRenderMapBuffer:
                render = CreateTriangleRenderMapBuffer();
                break;
            case KCubeRender:
                render = CreateCubeRender();
                break;
            default:
                break;
        }
