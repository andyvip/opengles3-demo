...
namespace glrender {
    ...
    class TriangleRenderVBO : public GLRender {
    public:
        virtual ~TriangleRenderVBO();
    ...
    void TriangleRenderVBO::Resize(int w, int h) {
        GLRender::Resize(w, h);
        glViewport(0, 0, w, h);
    }

    void TriangleRenderVBO::Render() {
    ...
    TriangleRenderVBO::~TriangleRenderVBO() {
        glDeleteProgram(program_);
    }

    GLRender *CreateTriangleRenderVBO() {
        TriangleRenderVBO *render = new TriangleRenderVBO;
        if (!render->Init()) {
            delete render;
            return NULL;
        }
